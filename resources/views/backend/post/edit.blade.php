    ...
    <div id="content" class="container-fluid">
        <div class="card">
            <div class="card-header font-weight-bold">
                <h5 class="m-0">Cập nhật bài viết</h5>
            </div>
            <div class="card-body">
                <form action="{{route('admin.post.update', ['id' => $post->id])}}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                @if ($post->avatar)
                                    <img src="{{url($post->avatar)}}" alt="" class="img-thumbnail" style="width:200px"
                                         id="imgOut">
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            ...
                            <input type="checkbox" class="form-check-input" id="exampleCheck1" name="status" value="1" {{ $post->status == 1 ? 'checked' : '' }}>
