    ...
    <div id="content" class="container-fluid">
        <div class="card">
            <div class="card-header font-weight-bold">
                <h5 class="m-0">Cập nhật chính sách</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.purchase_policy.update', $item->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            ...
                            <input type="checkbox" {{ $item->status == 1 ? 'checked' : '' }} class="form-check-input"
                                   id="exampleCheck1" name="status" value="1">
